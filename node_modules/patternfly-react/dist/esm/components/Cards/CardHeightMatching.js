  ...
  _createClass(CardHeightMatching, [{
    ...
    value: function componentDidMount() {
      ...
      this._selectors.forEach(function (selector) {
        var elements = _this2._container.querySelectorAll(selector);
        _this2._resizeSensors.push(new ResizeSensor(elements, debounce(function () {
          return _this2._matchHeights([selector]);
        }, 200)));
      });
