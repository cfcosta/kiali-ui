...
var Masthead = function Masthead(_ref) {
  var className = _ref.className,
      ...
      props = _objectWithoutProperties(_ref, ['className', 'title', 'titleImg', 'iconImg', 'href', 'onTitleClick', 'navToggle', 'onNavToggleClick', 'middleContent', 'children']);

  var mastheadClasses = classNames('navbar', 'navbar-pf-vertical', className);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('img', { className: 'navbar-brand-icon', src: iconImg, alt: '' }),
        React.createElement('img', { className: 'navbar-brand-name', src: titleImg, alt: title })
      ),
      middleContent
    ),
    children
