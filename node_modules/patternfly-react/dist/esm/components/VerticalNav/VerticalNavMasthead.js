...
var BaseVerticalNavMasthead = function BaseVerticalNavMasthead(props) {
  ...
  var brandChildren = childrenArray && childrenArray.filter(function (child) {
    return child.type === VerticalNavBrand;
  });
  var otherChildren = childrenArray && childrenArray.filter(function (child) {
    return child.type !== VerticalNavBrand;
  });
