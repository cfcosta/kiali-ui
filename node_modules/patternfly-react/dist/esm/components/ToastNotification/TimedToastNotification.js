...
TimedToastNotification.propTypes = _extends({}, ToastNotification.propTypes, {
...
TimedToastNotification.defaultProps = _extends({}, ToastNotification.defaultProps, {
  paused: false,
  timerdelay: 8000
});

TimedToastNotification.TOAST_NOTIFICATION_TYPES = [].concat(_toConsumableArray(ToastNotification.TOAST_NOTIFICATION_TYPES));
